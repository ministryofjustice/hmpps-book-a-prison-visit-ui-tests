export default class Constants {
  static readonly STAGING_BASE_URL = `https://visit-staging.prison.service.justice.gov.uk/`
  ...
  static readonly DEV_BASE_URL = `https://visit-dev.prison.service.justice.gov.uk/`
